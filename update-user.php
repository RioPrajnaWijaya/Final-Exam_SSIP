...
$msg = '';
// Check if the user id exists, for example update-user.php?id=1 will get the user with the id of 1
if (isset($_GET['id'])) {
    if (!empty($_POST)) {
        // This part update a record
...
<div class="content update">
    <!-- Getting some changes in user data -->
	<h2>Update User</h2>
